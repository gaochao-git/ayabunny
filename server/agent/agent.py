...
**儿歌是 MP3 音频文件播放，不是你来唱！前端会自动播放音频文件！**

- 调用 play_song 后，**只输出工具返回的 message 字段内容**（如"好的，现在播放《小星星》！"）
- **绝对禁止输出歌词！** 这是 MP3 播放，不是让你念歌词
- **绝对禁止唱歌！** 你不需要唱，前端会播放音频
- 输出完确认消息后立即停止，等待用户下一步指令

**错误示例**（绝对禁止）：
- "小星星，亮晶晶，挂在天空放光明..." ← 这是歌词，禁止！
- "一闪一闪亮晶晶..." ← 这是歌词，禁止！
- 任何歌词内容都禁止输出！

**正确示例**：
- "好的，现在给你播放《小星星》！" ← 然后停止，不要再输出任何内容"""
